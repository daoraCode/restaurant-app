export const data = [
  {
    ...
    img: 'https://www.dorchestercollection.com/wp-content/uploads/Le-meurice-alain-ducasse-paris-2.jpg',
    menu: {
  ...
  },
  {
    ...
    img: 'https://www.foodandwine.com/thmb/l2AB1aq0B53fhMpvUmFIHDT3X-0=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/Most-Iconic-Paris-Restaurants-FT-3-BLOG0922-2000-0ae7cc7a1e29490eb1caf4058e3fb42a.jpg',
    menu: {
      entrees: ['entree 1', 'entree 2'],
      dishes: ['plat 1', 'plat 2', 'plat 3'],
      deserts: ['desert 1', 'desert 2'],
  ...
  },
  {
    ...
    img: 'https://www.parismatch.com/lmnr/var/pm/public/media/image/2022/04/17/15/Under-the-sea-un-restaurant-sous-marin-A-Paris.jpg?VersionId=5qKzuQUs_wDVDAgSOOwn2IUvphOTlcdh',
    menu: {
      entrees: ['entree 1', 'entree 2'],
      dishes: ['plat 1', 'plat 2', 'plat 3'],
      deserts: ['desert 1', 'desert 2'],
  ...
  },
  {
    ...
    img: 'https://toitoimontoit.fr/wp-content/uploads/2017/07/Generator-Paris-Rooftop-Nov-2016-_66_0398-Copy.jpg',
    menu: {
      entrees: ['entree 1', 'entree 2'],
      dishes: ['plat 1', 'plat 2', 'plat 3'],
      deserts: ['desert 1', 'desert 2'],
  ...
  },
  {
    ...
    img: 'https://axwwgrkdco.cloudimg.io/v7/lefooding.com/medias/2022/06/DOKI-DOKI.jpg?width=1280&height=853&optipress=3',
    menu: {
      entrees: ['entree 1', 'entree 2'],
      dishes: ['plat 1', 'plat 2', 'plat 3'],
      deserts: ['desert 1', 'desert 2'],
